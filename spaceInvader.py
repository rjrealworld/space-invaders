...
#Background music
pygame.mixer.music.load("Virtual World - AShamaluevMusic.mp3") 
...
def help():
    ...
    mypen.penup()
    mypen.hideturtle()
    mypen.setposition(-180, -50)
    mypen.color("white")
    scorestring = "Use L/R key to move.\nUse space to shoot.\nPress q to exit." 
...
while True:
	...
	for enemy in enemies:
		...
		#Check for a collision b/w the bullet and the enemy
